...
int main(int argc, char *argv[]) {
  ...
  // make komutunu calistirdiktan sonra .o uzantılı
  // (object) dosyalari olustu. Compiler tarafindan
  // her bir kaynak (.c) dosyasi icin birer tane olusturulur.
  // compiler tarafindan olusturulmus makine kodu icerir.
